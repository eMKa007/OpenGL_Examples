...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Tutorial- Shadow Volume", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		renderShader.use();
		renderShader.setMat4("ModelViewMatrix", view);
		...
		renderShader.setVec3("LightPosition", lightPosition*view);
		...
		planeShader.setVec3("LightPosition", lightPosition*view);
		...
		volumeShader.setMat4("ModelViewMatrix", view);
		volumeShader.setMat4("ProjMatrix", projection);
		volumeShader.setVec3("LightPosition", lightPosition*view);

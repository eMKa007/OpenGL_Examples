...
Quad::Quad( float nrOfTexRepeats )
{
	...
	{
		// Position						// Color					// texcoord				// Normal
		glm::vec3(-0.5f, 0.5f, 0.f),	glm::vec3(0.5f, 0.5f, 0.5f),	glm::vec2(0.f, nrOfTexRepeats),	glm::vec3(0.f, 0.f, 1.f),	// Vertex 0
		glm::vec3(-0.5f, -0.5f, 0.f),	glm::vec3(0.5f, 0.5f, 0.5f),	glm::vec2(0.f, 0.f),	        glm::vec3(0.f, 0.f, 1.f),	// Vertex 1
		glm::vec3(0.5f, -0.5f, 0.f),	glm::vec3(0.5f, 0.5f, 0.5f),	glm::vec2(nrOfTexRepeats, 0.f),	glm::vec3(0.f, 0.f, 1.f),	// Vertex 2
		glm::vec3(0.5f, 0.5f, 0.f),		glm::vec3(0.5f, 0.5f, 0.5f),	glm::vec2(nrOfTexRepeats, nrOfTexRepeats),	glm::vec3(0.f, 0.f, 1.f)	// Vertex 3

...
void Game::initShaders()
{
	...
	this->shaders.push_back(
		new Shader(this->GL_VERSION_MAJOR, this->GL_VERSION_MINOR, 
			"Shaders/vertex_shader_box.vert", 
			"Shaders/fragment_shader_box.frag"));

	this->shaders.push_back(
	new Shader(this->GL_VERSION_MAJOR, this->GL_VERSION_MINOR,
		"Shaders/vertex_shader_sphere.vert",
		"Shaders/fragment_shader_sphere.frag"));

	this->shaders.push_back(
	new Shader(this->GL_VERSION_MAJOR, this->GL_VERSION_MINOR,
		"Shaders/vertex_shader_floor.vert",
		"Shaders/fragment_shader_floor.frag"));
}
...
void Game::RenderFromCameraPOV()
{
	...
	this->models[MODEL_SPIDER]->render(this->shaders[SHADER_SPHERES], GL_TRIANGLES);
